...
extern "C" IL2CPP_METHOD_ATTR void LostTrackingService_DisableTrackingLostVisual_m044FDEEFC796A932C81B312C163EE35498936F5A (LostTrackingService_t1B63948CC6D0AA9AFFBF8FBEF24E28468E495806 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_5);
		bool L_6 = LostTrackingServiceProfile_get_HaltTimeWhileTrackingLost_m8A0B173FA6EC346FF29C6445874EE60BF1FB1E15(L_5, /*hidden argument*/NULL);
		if (!L_6)
		{
			goto IL_003d;
		}
...
IL_003d:
	{
		...
		NullCheck(L_8);
		bool L_9 = LostTrackingServiceProfile_get_HaltAudioOnTrackingLost_m1555D8DE1D7B66887641524C307A87391F9F8935(L_8, /*hidden argument*/NULL);
		if (!L_9)
		{
			goto IL_0050;
		}
...
extern "C" IL2CPP_METHOD_ATTR void LostTrackingService_EnableTrackingLostVisual_m063C9C567A37B42897863A903070CA03D0280526 (LostTrackingService_t1B63948CC6D0AA9AFFBF8FBEF24E28468E495806 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_1);
		GameObject_tBD1244AD56B4E59AAD76E5E7C9282EC5CE434F0F * L_2 = LostTrackingServiceProfile_get_TrackingLostVisualPrefab_m4D5699F51D3A125EFB0BBF34A614B7351CB36295(L_1, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Object_tAE11E5E46CD5C37C9F3E8950C00CD8B45666A2D0_il2cpp_TypeInfo_var);
...
IL_004d:
	...
	}
	{
		...
		NullCheck(L_16);
		LayerMask_tBB9173D8B6939D476E67E849280AC9F4EC4D93B0  L_17 = LostTrackingServiceProfile_get_TrackingLostCullingMask_m34DC48DCE6353D079B88020D83E8A62CDA7E9E4F(L_16, /*hidden argument*/NULL);
		...
		NullCheck(L_19);
		bool L_20 = LostTrackingServiceProfile_get_HaltTimeWhileTrackingLost_m8A0B173FA6EC346FF29C6445874EE60BF1FB1E15(L_19, /*hidden argument*/NULL);
		if (!L_20)
		{
			goto IL_00a9;
		}
...
IL_00a9:
	{
		...
		NullCheck(L_21);
		bool L_22 = LostTrackingServiceProfile_get_HaltAudioOnTrackingLost_m1555D8DE1D7B66887641524C307A87391F9F8935(L_21, /*hidden argument*/NULL);
		if (!L_22)
		{
			goto IL_00bc;
		}
...
IL_00bc:
	{
		...
		NullCheck(L_25);
		int32_t L_26 = LostTrackingServiceProfile_get_TrackingLostVisualLayer_m48B951FA7ABFE778E6EB4266FA350FDAB71D81C4(L_25, /*hidden argument*/NULL);
		NullCheck(L_24);
...
extern "C" IL2CPP_METHOD_ATTR void LostTrackingService_SetTrackingLost_m86E118CC2BFEC1650D2B7A84E67EFC82F6462887 (LostTrackingService_t1B63948CC6D0AA9AFFBF8FBEF24E28468E495806 * __this, bool ___trackingLost0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		LostTrackingService_set_TrackingLost_mF044AEDBF190E19BA36FB1C3008514B0A0746C88(__this, L_2, /*hidden argument*/NULL);
		// if (TrackingLost)
		bool L_3 = LostTrackingService_get_TrackingLost_mBE500DA30515E9538FEA4CC8CA146CDB8F469A27(__this, /*hidden argument*/NULL);
		if (!L_3)
		{
			goto IL_0030;
		}
	}
	{
		...
		Action_t591D2A86165F896B4B800BB5C25CE18672A55579 * L_4 = LostTrackingService_get_OnTrackingLost_mEB7A801B50C4FF0750833A5423BEF2879C8883FF(__this, /*hidden argument*/NULL);
...
IL_0030:
	{
		...
		Action_t591D2A86165F896B4B800BB5C25CE18672A55579 * L_6 = LostTrackingService_get_OnTrackingRestored_m9621CF9C0DF33E5EC2BC664947EA112DB39DB0AC(__this, /*hidden argument*/NULL);
